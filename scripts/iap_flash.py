...
def main():
    ...
    with open(out_path, "w") as out:
        out.write("# Auto-generated by scripts/iap_flash.py — do not edit by hand.\n")
        out.write("# Drive it from telnet:  telnet localhost 4444  ->  source flash_iap.tcl\n\n")

        out.write("proc program_iap {} {\n")
        out.write('    echo "=== IAP firmware programming ==="\n\n')

        out.write("    # Clock + WDT bring-up (procs defined in openocd/openocd.cfg).\n")
        out.write("    wdt_init\n")
        out.write("    set_clock_48mhz\n")
        out.write("    wdt_clear\n\n")

        out.write("    # Erase the 32 KB block containing the IAP region.\n")
        out.write(f'    echo "Erasing block 0x{ERASE_BLOCK_ADDR:08X} ({ERASE_BLOCK_SIZE} bytes)..."\n')
        ...
        out.write("    # Re-open for write phase.\n")
        ...
        out.write("    # Disable self-program and close.\n")
        out.write("    flash_self_program 0x5A5A5A5A\n")
        out.write("    flash_close\n")
        out.write("    wdt_clear\n\n")

        out.write('    echo "=== IAP programmed. Reset the chip to boot it. ==="\n')
        out.write("}\n\n")
